...
export function StepAvatarSelection({ onNext, onBack, onSkip }: StepAvatarSelectionProps) {
          ...
          return (
            <div
              ...
              style={{
                ...
                padding: '24px',
                borderRadius: '12px',
                border: isSelected ? '2px solid var(--color-primary, #3b82f6)' : '2px solid var(--color-border, #e5e7eb)',
          ...
          {ACCESSORIES.map((a) => (
            <button
              ...
              style={{
                padding: '8px 16px',
                borderRadius: '20px',
                border: accessory === a.id ? '1px solid var(--color-primary, #3b82f6)' : '1px solid var(--color-border, #d1d5db)',
                backgroundColor: accessory === a.id ? 'var(--color-primary-light, #eff6ff)' : 'transparent',
                color: accessory === a.id ? 'var(--color-primary, #3b82f6)' : 'var(--color-text, #111827)',
                cursor: 'pointer',
                fontSize: '14px',
